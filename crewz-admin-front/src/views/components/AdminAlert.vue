	...
	<div class="alert h-auto p-3">
		...
		<div class="mt-5 w-full">
			...
			<p class="mt-1 text-sm font-normal text-gray-400">
				This Alert component helps you to notify about success and
				danger messages.
			</p>
		</div>
		<!-- grid wrapper card -->
			...
			>
				<div class="pb-5 space-y-4">
					...
					<p class="dark:text-gray-200">
						you can change background colors by adding props and
						text in your alert components.
					</p>
				</div>
				<div class="wrapper-alert grid grid-cols-1 gap-3 mt-3">
					...
					<alert class="bg-orange-500 text-white">
						<template v-slot:content>
							Hello iam alert warning</template
						>
					</alert>
					<alert class="bg-red-500 text-white">
						<template v-slot:content>
							Hello iam alert danger</template
						>
					</alert>
			...
			>
				<div class="pb-5 space-y-4">
					...
					<p class="dark:text-gray-200">
						...
						<span class="text-red-500 bg-gray-200"
							>v-slot:heading</span
						>
						on alert components.
					</p>
				...
				<div class="pb-5 space-y-4">
					...
					<p class="dark:text-gray-200">
						...
						<span class="text-red-500 bg-gray-200"
							>v-slot:icon</span
						>
						and use iconify for default or others.
					</p>
				</div>
			...
			>
				<div class="pb-5 space-y-4">
					...
					<p class="dark:text-gray-200">
						...
						on your alert components to use Dismissable alert
					</p>
					<p class="dark:text-gray-200">
						and change the demo props to
						<span class="text-red-500 bg-gray-200">false</span>,
						aiming not to spawn the alert again
					</p>
				</div>
				<div class="wrapper-alert grid grid-cols-1 gap-3 mt-3">
					<alert
