			...
			>
				<div class="">
					...
					<p class="text-gray-400">
						This is list if your partner online.
					</p>
				</div>
				<perfect-scrollbar
					class="divide-y h-96 mt-5 dark:divide-gray-700"
				>
					<div class="p-3 w-full">
						<div class="flex gap-5">
							...
							<div class="mt-1">
								...
								<p
									class="text-sm dark:text-gray-500 text-gray-400"
								>
									Active now
								</p>
							</div>
						...
						>
							...
							<td class="px-6 py-4">
								<span
									...
									v-if="
										items.statusTransaction == 'completed'
									"
								>
								...
								<span
									...
									v-else-if="
										items.statusTransaction == 'progress'
									"
								>
									{{ items.statusTransaction }}
								</span>
